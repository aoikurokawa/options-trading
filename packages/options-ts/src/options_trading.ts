export type OptionsTrading = {
  ...
  "errors": [
    ...
    },
    {
      ...
      "msg": "WriteToken mint does not match the value on the OptionMarket"
    },
    {
      "code": 6015,
    ...
    },
    {
      ...
      "msg": "OptionMarket has not expired, can't exercise"
    },
    {
      "code": 6022,
      "name": "OptionMarketNotExpirationCantClose",
...
export const IDL: OptionsTrading = {
  "version": "0.1.0",
  "name": "options_trading",
  "instructions": [
    {
