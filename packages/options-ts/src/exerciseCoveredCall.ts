 ...
 * @param exerciseQuoteAssetKey public key where the quote asset will be transfered from
 * @param exerciseUnderlyingAssetKey public key where the underlying asset will be transfered to
 * @param exerciseQuoteAssetAuthorityKey owner of the exerciserQuoteAssetKey, likely the wallet
 ...
 * @param quoteAssetPoolKey public key of the quote asset pool for the market, where the asset will be of the quote asset pool
 * @param optionTokenKey public key of the account where the Option Token will be burned from
 * @param optionTokenAuthorityKey owner of the optionKey, likely the wallet
 * @param fundingAccountKey The payer account that is funding the SOL for the TX making the transaction
...
export const exerciseCoveredCallInstruction = async ({
  ...
  const keys: AccountMeta[] = [
    ...
    { pubkey: optionTokenAuthorityKey, isSigner: true, isWritable: false },
 ...
 * @param exerciseQuoteAssetKey Pubkey of where the Quote Asset will be sent from
 * @param exerciseUnderlyingAssetkey Pubkey of where the Underlying asset will be sent to
 * @param exerciseQuoteAssetAuthorityAccount Account that owns and can sign TXs on behalf of the Quote Asset Pubkey above
 * @param optionTokenKey Pubkey for the account to burn the Option Mint from
 * @param optionTokenAuthorityAccount Account that owns the Pubkey to burn Option Mint from
