...
// import * as BufferLayout from "@solana/buffer-layout-utils";
...
export class Market {
  ...
  static getDerivedAddressFromParams = async ({
    ...
    NS64_LAYOUT.encode(underlyingAmountPerContract, underlyingAmountBuf);
   ...
   * only one's where the underlying asset and quote assets are supported
   * @param {Connection} connection
   * @param {PublicKey} programId
