 ...
 *
 * This instruction will burn a Writer Token and transfer underlying asset back to the specified account.
 * The amount of underlying asset transfered depends on the underlying amount per contract, aka 'contract size'
 *
 ...
 * @param underlyingAssetDestKey publickey of the account to send the underlying asset to
 ...
 * @param size number of position to close (writer tokens to burn)
 * @returns
 */
...
/**
 * Features the underlying asset pool address from on chain for convenience
 * @param connection
 * @param payerKey
 * @param programId
